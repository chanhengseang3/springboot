 ...
 */
@RestController
public class ClassicGraphQLController {

    private static final String PATH = "/v0/graphql";
     ...
     */
    public ClassicGraphQLController(@Qualifier("classicExecutor") GraphQLExecutor graphQLExecutor, ObjectMapper mapper) {
        super();
